...
A zero-dependency project scheduling engine with Critical Path Method, Monte Carlo risk simulation, resource-leveling, what-if analysis, and Gantt chart visualization. Features seeded PRNG for deterministic simulations, 18 self-tests, 17 exports, and 3 built-in templates. Designed as a PM copilot that turns task lists into optimized, risk-aware schedules.
